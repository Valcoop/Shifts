...
CREATE TABLE `user-slots-absences` (
  id INT PRIMARY KEY NOT NULL AUTO_INCREMENT,
  userID INT NOT NULL,
  ...
  FOREIGN KEY (absenceTypeID) REFERENCES `absence-types`(id) ON DELETE NO ACTION ON UPDATE NO ACTION
);
...
CREATE TABLE `user-slots` (
  ...
  FOREIGN KEY (userSlotAbsenceID) REFERENCES `user-slots-absences`(id) ON DELETE NO ACTION ON UPDATE NO ACTION
);
